...
- **📧 邮件发送**：支持 Cloudflare Email Sending 和 Resend 两种发信方式，支持群发，内嵌图片和附件发送，发送状态查看
...
- **邮件推送：** [Cloudflare Email Sending](https://developers.cloudflare.com/email-service/api/send-emails/workers-api/) / [Resend](https://resend.com/)
