const en = {
    ...
    save: 'Save',
    profile: 'Profile',
    accountBind: 'Linked Accounts',
    bind: 'Link',
    unbind: 'Unlink',
    notBind: 'Not linked',
    bindSuccessMsg: 'Linked successfully',
    unbindSuccessMsg: 'Unlinked successfully',
    unbindConfirm: 'Confirm unlinking {msg}?',
    noOauthPlatform: 'The administrator has not enabled third-party login',
    change: 'Change',
    changePwdBtn: 'Change',
    username: 'Username',
    trustLevel: 'Level',
