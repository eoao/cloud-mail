const en = {
    ...
    admin: 'Admin',
    addUser: 'Add User',
    batchCreateUsers: 'Batch Create',
    importUsers: 'Import Users',
    exportUsers: 'Export Selected',
    userCount: 'User Count',
    usernamePrefixHint: 'Username/email prefix (random if blank)',
    optionalPasswordHint: 'Password (random if blank)',
    createAndExport: 'Create & Export Credentials',
    downloadCsvTemplate: 'Download CSV Template',
    downloadXlsxTemplate: 'Download Excel Template',
    selectImportFile: 'Select a CSV or Excel file',
    defaultRole: 'Default Role',
    importRows: '{count} rows parsed',
    importAndExport: 'Import & Export Credentials',
    generatedCredentials: 'Generated User Credentials',
    credentialsSecurityTip: 'Copy or download this list now. Plain-text passwords are not stored for security.',
    downloadCredentials: 'Download Credentials CSV',
    batchCreatedCount: '{count} users created successfully',
    batchFailureCount: '{count} rows could not be created. Check email, password, or role.',
    batchMaxUsers: 'A maximum of {count} users can be processed at once.',
    importEmptyFile: 'The import file has no usable data rows.',
    importParseFailed: 'Unable to parse the import file.',
    copySuccess: 'Copied to clipboard.',
    copyFailed: 'Copy failed. Please copy manually.',
    selectUsersToExport: 'Select users to export first.',
    existingPasswordNotExportable: 'Emails and password status were exported. Existing plain-text passwords are shown only at creation; the database stores irreversible hashes, so they cannot be recovered or exported.',
    passwordNotStored: 'Plain-text password not stored (irreversible hash only)',
    select: 'Select',
    unknown: 'Unknown',
