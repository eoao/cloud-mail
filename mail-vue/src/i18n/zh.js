const zh = {
    ...
    admin: '超级管理员',
    addUser: '添加用户',
    batchCreateUsers: '批量新建',
    importUsers: '批量导入',
    exportUsers: '导出选中用户',
    userCount: '用户数量',
    usernamePrefixHint: '用户名/邮箱前缀（留空随机）',
    optionalPasswordHint: '密码（留空随机生成）',
    createAndExport: '创建并导出凭据',
    downloadCsvTemplate: '下载 CSV 模板',
    downloadXlsxTemplate: '下载 Excel 模板',
    selectImportFile: '选择 CSV 或 Excel 文件',
    defaultRole: '默认权限身份',
    importRows: '已解析 {count} 行',
    importAndExport: '导入并导出凭据',
    generatedCredentials: '本次生成的用户凭据',
    credentialsSecurityTip: '请立即复制或下载此清单。为安全起见，系统不会保存明文密码。',
    downloadCredentials: '下载凭据 CSV',
    batchCreatedCount: '已成功创建 {count} 个用户',
    batchFailureCount: '{count} 行未能创建，请检查邮箱、密码或角色。',
    batchMaxUsers: '单次最多处理 {count} 个用户。',
    importEmptyFile: '导入文件没有可用的数据行。',
    importParseFailed: '无法解析导入文件。',
    copySuccess: '已复制到剪贴板。',
    copyFailed: '复制失败，请手动复制。',
    selectUsersToExport: '请先选择要导出的用户。',
    existingPasswordNotExportable: '已导出邮箱与密码状态。已有用户的明文密码仅在创建时显示，数据库只保存不可逆哈希，无法恢复或导出。',
    passwordNotStored: '明文密码未保存（仅存不可逆哈希）',
    select: '请选择',
    unknown: '未知',
    changePerm: '修改权限',
    from: '发件人',
