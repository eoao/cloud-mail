const en = {
	...
	JWTMismatch: 'JWT secret mismatch',
        ...
        oauthProviderDisabled: 'OAuth provider is not configured',
        oauthUnsupportedProvider: 'Unsupported OAuth provider',
        oauthInvalidCallback: 'Invalid OAuth callback parameters',
        oauthStateInvalid: 'OAuth state validation failed',
        oauthExchangeFailed: 'Failed to exchange OAuth token',
