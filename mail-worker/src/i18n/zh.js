const zh = {
	...
	signatureLengthLimit: '签名最多 5000 个字符',
	totpRequired: '请输入验证器应用中的验证码',
	totpInvalid: '验证码无效',
	totpNotStarted: '请先开始两步验证设置',
	totpAlreadyOn: '两步验证已启用',
	invalidScheduleTime: '日期时间无效',
	sendAlreadyLeft: '为时已晚 - 邮件已交给发送服务商',
