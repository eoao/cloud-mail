const zh = {
	...
	JWTMismatch: 'jwt_secret 不匹配',
        ...
        oauthProviderDisabled: '第三方登录未配置',
        oauthUnsupportedProvider: '暂不支持的第三方登录方式',
        oauthInvalidCallback: '第三方登录回调参数无效',
        oauthStateInvalid: '第三方登录状态校验失败',
        oauthExchangeFailed: '第三方登录换取令牌失败',
