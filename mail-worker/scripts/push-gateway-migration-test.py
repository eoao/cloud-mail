...
cur.execute("INSERT INTO push_subscription(user_id,subscription_id,push_secret,account_ref) VALUES(2,'ps_aaaaaaaaaaaaaaaaaaaa','pgs_bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb','22222222-2222-4222-8222-222222222222')")
con.commit()
...
print('push gateway migration: PASS')
